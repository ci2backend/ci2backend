(function(A) {
    A.extend(A.fn, {
        pstrength: function(B) {
            var B = A.extend({
                verdects: [lang['very_weak'], lang['weak'], lang['medium'], lang['strong'], lang['very_strong']],
                colors: ["#f00", "#c06", "#f60", "#3c0", "#3f0"],
                scores: [10, 15, 30, 40],
                common: ["password", "sex", "god", "123456", "123", "liverpool", "letmein", "qwerty", "monkey", "phanquocgiam", "giahuy", "111111", "222222", "333333", "444444", "555555", "666666", "777777", "888888", "999999", "000000"],
                minchar: 6
            }, B);
            return this.each(function() {
                var C = A(this).attr("id");
                A(this).after("<div class=\"pstrength-info\" id=\"" + C + "_text\"></div>");
                A(this).after("<div class=\"indicator\" style=\"margin-top: 10px;\"><div class=\"pstrength-bar reverse\" id=\"" + C + "_bar\" style=\"width: 0%;\"></div></div>");
