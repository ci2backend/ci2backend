...
function Messi(e, t) {
    ...
    if (n.options.buttons.length > 0) {
        for (var i = 0; i < n.options.buttons.length; i++) {
            ...
            var id = n.options.buttons[i]["id"];
            var o = jQuery('<div class="btnbox"><button class="btn ' + s + '" href="javascript:void(0);" id="' + id + '">' + n.options.buttons[i].label + "</button></div>").data("value", n.options.buttons[i].val);
            if (n.options.buttons[i]["class"] == 'return') {
