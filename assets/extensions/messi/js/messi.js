...
function Messi(data, options) {
    ...
    if (_this.options.buttons.length > 0) {
        for (var i = 0; i < _this.options.buttons.length; i++) {
            ...
            var id = _this.options.buttons[i]["id"];
            var btn = jQuery('<div class="btnbox"><button class="btn ' + cls + '" href="javascript:void(0);" id="' + id + '">' + _this.options.buttons[i].label + '</button></div>').data('value', _this.options.buttons[i].val);
            if (_this.options.buttons[i]["class"] == 'return') {
...
Messi.prototype = {
    ...
    show: function() {
        ...
        this.messi.addClass('messi-fade');
