...
class T_constants extends MY_Model 
{

	protected $_table_name = 'constants'; // table name
    ...
    public $rules_create = array(
        array(
            'field' => 'constant', 
            'label' => 'lang:Constant', 
            'rules' => 'trim|required|max_length[100]|is_unique[constants.constant]'
        ),
        array(
            'field' => 'value', 
            'label' => 'lang:Value', 
	...
	/**
	 * [delete_data_by_id description]
	 * @param  string $id [description]
	 * @return bool 	  [description]
	 */
	public function delete_data_by_id($id = null) {
