...
class Ion_auth_model extends CI_Model
{
    ...
    public function get_groups_users($id = FALSE)
    {
        $this->trigger_events('get_users_group');
        ...
        return $this->db->select($this->tables['groups'] . '.name')->where($this->tables['users_groups'] . '.' . $this->join['users'], $id)->join($this->tables['groups'], $this->tables['users_groups'] . '.' . $this->join['groups'] . '=' . $this->tables['groups'] . '.id')->get($this->tables['users_groups']);
    }
