 ...
 */
$config['site_title']                 = "Codeigniter Backend 1.0";       // Site Title, example.com
$config['admin_email']                = "phu_tv@live.com"; // Admin Email, admin@example.com
...
$config['lockout_time']               = 7200;                 // The number of seconds to lockout an account due to exceeded attempts
